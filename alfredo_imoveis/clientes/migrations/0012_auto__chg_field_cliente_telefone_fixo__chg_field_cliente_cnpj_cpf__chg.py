...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cliente.telefone_fixo'
        db.alter_column(u'clientes_cliente', 'telefone_fixo', self.gf('django.db.models.fields.CharField')(default='', max_length=11))

        # Changing field 'Cliente.cnpj_cpf'
        db.alter_column(u'clientes_cliente', 'cnpj_cpf', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Cliente.email'
        db.alter_column(u'clientes_cliente', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

    def backwards(self, orm):

        # Changing field 'Cliente.telefone_fixo'
        db.alter_column(u'clientes_cliente', 'telefone_fixo', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'Cliente.cnpj_cpf'
        db.alter_column(u'clientes_cliente', 'cnpj_cpf', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Cliente.email'
        db.alter_column(u'clientes_cliente', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        u'clientes.cliente': {
            ...
            'telefone_fixo': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
