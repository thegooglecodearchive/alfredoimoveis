...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cliente.nome_pai'
        db.add_column(u'clientes_cliente', 'nome_pai',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cliente.nome_mae'
        db.add_column(u'clientes_cliente', 'nome_mae',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cliente.nome_pai'
        db.delete_column(u'clientes_cliente', 'nome_pai')

        # Deleting field 'Cliente.nome_mae'
        db.delete_column(u'clientes_cliente', 'nome_mae')
