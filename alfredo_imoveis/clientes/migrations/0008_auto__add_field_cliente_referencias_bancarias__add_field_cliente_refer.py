...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.referencias_bancarias'
        db.add_column(u'clientes_cliente', 'referencias_bancarias',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cliente.referencias_comerciais'
        db.add_column(u'clientes_cliente', 'referencias_comerciais',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.referencias_bancarias'
        db.delete_column(u'clientes_cliente', 'referencias_bancarias')

        # Deleting field 'Cliente.referencias_comerciais'
        db.delete_column(u'clientes_cliente', 'referencias_comerciais')
