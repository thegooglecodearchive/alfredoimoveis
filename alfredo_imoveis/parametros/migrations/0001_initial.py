...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'parametros_parametrosgerais', (
            ...
            ('taxa_juros', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1)),
    ...
    models = {
        ...
        u'parametros.parametrosgerais': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'taxa_juros': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '1'}),
